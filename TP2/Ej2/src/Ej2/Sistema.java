...
public class Sistema {
    ...
    public Paquete nuevoPaquete(String destino, Proveedor transporte,
                             Proveedor hospedaje, Proveedor excursion) {
        Integer idPaquete = listaPaquetes.size() + 1;
        Paquete paquete = Paquete.generarPaquete(idPaquete,destino,transporte,hospedaje,excursion);
